 ...
 * get i_th bit. 
 * resolution: u8. 
 * CAUTION: the actural resolution of message in NAS PDU is u8. */
 ...
 * 
 * @return netSeq u8 MAC
 * 
 */
u8* EIA3_Calculates_MAC(u8 *integrity_key, u32 count, u32 bearer, u32 direction, 
