 ...
 * 
 * @param k Cipher Key(CK): generated from HSS(KASME, one of authentication vector field containing CK & IK)
 * @param iv Initialization Vector
 * @param ks Key Stream: output param, used for encryption or integrity checking
 * @param len length of KeyStream, {len} bytes
 * 
 */
